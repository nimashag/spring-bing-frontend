    ...
    <div className="dashboard-layout">
      ...
      <main className="main-content">
        <header className="header">
          <div className="header-left">
            ...
            <div className="user-info">
              <h2 className="text-xl font-bold">Vihanga Nethusara</h2>
        ...
        <div className="dashboard-container">
          ...
          {/* dewani KAAALLA */}
          <h2 className="text-xl font-bold leading-snug text-black mt-6">
            Products Dashboard
          </h2>
          <div className="flex w-full md:flex-row  items-center gap-5">
            <section className="dashboard-overview-2">
              <div className="stat-card">
                ...
                <p className="mt-2 ">
                  Upload new products to the catalog and View items, update or
                  remove products.
                </p>
              ...
              <div className="stat-card ">
                ...
                <p className="mt-2">
                  Generate insights on stock levels and order performance, sales
                  strategies.
                </p>
              ...
              <div className="stat-card ">
                ...
                <p className="mt-2">
                  Reports and statistics on perfomance of trending products.
                </p>
                <Link to="/admin/stat-products">
          ...
          <h2 className="text-xl font-bold leading-snug text-black mt-5">
            Sales Dashboard
          </h2>
          <section className="dashboard-overview">
            <div className="stat-card flex items-center">
              ...
              <div className="ml-5">
                ...
                <p className="mt-2 text-left">
                  Predict future sales based on historical data, trends,
            ...
            <div className="stat-card flex items-center">
              ...
              <div className="ml-5">
                ...
                <p className="mt-2 text-left">
                  Adjust prices in real-time based on demand, competition, and
            ...
            <div>
              ...
              <section className="dashboard-overview-2">
                <div className="stat-card">
                  ...
                  <img src={faqimg} />
                  <p className="mt-2 ">
                    Oversee and update frequently asked questions to ensure
                ...
                <div className="stat-card">
                  ...
                  <p className="mt-2 ">
                    Monitor and manage product reviews, including editing
                    deleting and reporting as needed.
                  </p>
                ...
                <div className="stat-card">
                  ...
                  <p className="mt-2 ">
                    Analyze customer feedback with insights on ratings and
              ...
              <section className="dashboard-overview">
                <div className="stat-card flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-left">
                      Easily view, track, and update customer orders, ensuring
                      smooth order fulfillment and timely delivery.
                    </p>
                ...
                <div className="stat-card flex items-center">
                  ...
                  <div className="ml-5">
                    ...
                    <p className="mt-2 text-left">
                      Access detailed financial summaries, including revenue,
                      expenses, and profit trends.
                    </p>
