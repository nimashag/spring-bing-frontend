...
const CreateProduct: React.FC = () => {
  ...
  const validateForm = (form) => {
    ...
    if (
      isNaN(form.unit_price.value) ||
      parseFloat(form.unit_price.value) <= 0
    ) {
              ...
              <div key={index} className="flex flex-col lg:flex-row gap-6">
                <div className="w-full">
                  ...
                  <TextInput
                    ...
                    value={item.color}
                    onChange={(e) =>
                      handleMetadataChange(index, "color", e.target.value)
                    }
                    // required
                  />
                ...
                <div className="w-full">
                  ...
                  <TextInput
                    ...
                    value={item.size}
                    onChange={(e) =>
                      handleMetadataChange(index, "size", e.target.value)
                    }
                    // required
                  />
