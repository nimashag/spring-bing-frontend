      ...
      <div className="main-content">
          ...
          <table className="w-full table-auto bg-white shadow-lg rounded-lg border border-gray-300 overflow-hidden">
            <thead className="bg-sky-700 text-white">
              <tr>
                ...
                <th className="px-6 py-4 text-left text-sm font-semibold"><span>Action</span></th>
              </tr>
            </thead>
        ...
        <div className="flex justify-between items-center mt-6">
          ...
          <div className="flex gap-2">
            <button
              className={`px-4 py-2 rounded-lg ${currentPage === 1 ? 'bg-gray-400 cursor-not-allowed' : 'bg-sky-500 hover:bg-sky-700 text-white'}`}
            ...
            <button
              className={`px-4 py-2 rounded-lg ${currentPage === totalPages ? 'bg-gray-400 cursor-not-allowed' : 'bg-sky-500 hover:bg-sky-700 text-white'}`}
